  ...
  return (
    <OnboardingBlock>
      <OnboardingWrapper>
        <OnboardingHeader>
          <XaltLogoLink />
          <OnboardingStep>Step 1 of 5</OnboardingStep>
          <LogoutDropdown />
        </OnboardingHeader>
        <OnboardingMain>
          ...
          <OnboardingStepWrapper>
            <Container min centered mt="40px">
              <Heading center>What are your health and fitness goals?</Heading>
              <Paragraph maxWidth="580px" big center>
                Define your goals so your coach can customize your experience to best suit your
                needs.
              </Paragraph>
              <OnboardingList>
                {domains.map((domain) => (
