        ...
        <OnboardingMain>
          <OnboardingStepWrapper>
            <Container min centered mt="40px">
              <Heading center>
                A restore password link has been sent to your email account
              </Heading>
              <Paragraph maxWidth="580px" big center>
                Please, click to the link that has just been sent to your email
                account to go to the restore password page.
              </Paragraph>
